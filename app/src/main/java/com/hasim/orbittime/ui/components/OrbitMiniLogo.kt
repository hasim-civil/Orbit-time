 ...
 * (viewBox 32x32: a –28°-tilted ring stroked with a blue-to-purple gradient, a light
 * center dot, and a small violet accent dot near the ring's upper edge). Used in the top bar.
 */
@Composable
